...
public class ServiceMetadataContent extends AbstractBaseGetCapabilitiesFixture {
     ...
     */
    //private final String NSG_ABSTRACTSTATEMENT = "This service implements the NSG WMTS 1.0.0 profile version 1.0 xxx";
    ...
    @Test(description = "DGIWG WMTS 1.0, Requirement 14", dependsOnMethods = "wmtsCapabilitiesServiceIdentificationExists")
