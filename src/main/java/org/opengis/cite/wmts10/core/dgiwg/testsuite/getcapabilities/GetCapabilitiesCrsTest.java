...
public class GetCapabilitiesCrsTest extends AbstractBaseGetCapabilitiesFixture {
    /**
     * --- NSG Requirement 11: A WMTS server shall support at least on the folowwing WKKS : see DGIWG ANNEX B.1 (EPSG:3395), 
     * B.2 (EPSG:4326 and CRS 84) and B.3 (UPS Tiles EPSG:5041 and EPSG:5042). ---
     */

    @Test(description = "DGWIG requirement 3", dependsOnMethods = "verifyGetCapabilitiesSupported")
    public void wmtsCapabilitiesExists() {
        assertTrue( this.wmtsCapabilities != null, "No ServerMetadata Capabilities document" );
    }

    @Test(description = "DGWIG requirement 3", dependsOnMethods = "wmtsCapabilitiesExists")
