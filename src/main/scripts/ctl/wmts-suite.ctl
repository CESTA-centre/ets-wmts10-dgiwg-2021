...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl" 
  ...
  <ctl:function name="tns:run-ets-${ets-code}">
    ...
    <ctl:description>Runs the DGIWG WMTS 1.0.0 (${version}) test suite.</ctl:description>
    <ctl:code>
  ...
  <ctl:suite name="tns:ets-${ets-code}-${version}">
    ...
    <ctl:description>Checks DGIWG WMTS 1.0.0 implementations for conformance to DGIWG WMTS 1.0.0.</ctl:description>
        ...
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          ...
          <div style="background:#F0F8FF" bgcolor="#F0F8FF">
            <fieldset style="background:#ccffff">
              ...
              <p>
                <label for="wmts-uri">
                  <h4 style="margin-bottom: 0.5em">Location of WMTS capabilities document (http: or file: URI)</h4>
                </label>
